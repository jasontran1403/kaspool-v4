...
const TransactionTableV2Transfer = ({ TABLE_HEAD, TABLE_ROWS }) => {
  ...
  const handleCopy = (input) => {
    navigator.clipboard.writeText(input)
      .then(() => {
        ...
        toast.success(`Transfer history's code has been copied`, {
          position: "top-right",
          autoClose: 1500,
        });
      })
                        ...
                        <tr key={code}>
                          <td className={classes}>
                            <Typography
                              variant="small"
                              color="white"
                              className={`font-normal ${method === 0 ? "text-red" : "text-green"}`}
                            >
                              {method === 0 ? `To ${to}` : `From ${from}`}
                            </Typography>
                            <Typography
                              variant="small"
                              color="white"
                          ...
                          <td className={`${classes} status`}>
                            ...
                            >
                              ...
                              </svg> : status === "success" ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16">
...
export default TransactionTableV2Transfer;
